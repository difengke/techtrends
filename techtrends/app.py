...
def post(post_id):
    ...
    if post is None:
      app.logger.info('The requested article does not exist.')
      return render_template('404.html'), 404
    else:
      app.logger.info('An article is retrieved with title : '+post['title'])
...
def metrics():
    ...
    connection.close()
    data = {"db_connection_count": connection_count, "post_count": post_count[0]}
    return data
